...
class ImageSquareView extends Component {
  constructor(props) {
      super(props)
      this.state = {
            ...
            {this.showHeader()}
                <View style={{backgroundColor:'#FFFFFF',borderTopWidth:1,borderBottomWidth:1,borderColor:'#D8D8D8'}}>
                    <View style={{flexDirection:'row'}}>
                        <View style={{borderRightWidth:1,borderColor:'#D8D8D8',flex:1,padding:10,alignItems:'center'}}>
                            <Image style={{width, height}} source={{uri:this.props.details.image1}}/>
                        </View>
                        <View style={{flex:1,padding:10,alignItems:'center'}}>
                            <Image style={{width, height}} source={{uri:this.props.details.image2}}/>
                    ...
                    <View style={{flexDirection:'row',borderTopWidth:1,borderColor:'#D8D8D8'}}>
                        <View style={{borderRightWidth:1,borderColor:'#D8D8D8',flex:1,padding:10,alignItems:'center'}}>
                            <Image style={{width, height}} source={{uri: this.props.details.image3}}/>
                            <Text style={{textAlign:'center'}}>{this.props.details.text3}</Text>
                        </View>
                    <View style={{flex:1,padding:10, alignItems:'center',}}>
                        <Image style={{width, height}} source={{uri: this.props.details.image4}}/>
                    </View>
                </View>
            </View>
            {this.showFooter()}
...
const styles = ReactNative.StyleSheet.create({
  ...
  export default ImageSquareView