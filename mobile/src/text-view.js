...
class TextView extends Component {
  ...
  render(){
    ...
    return(
        <View style={{flex: 1, padding: 0, borderColor:'#D8D8D8',borderBottomWidth:1, backgroundColor: '#FFFFFF'}}>
            <View style={{borderColor:'#D8D8D8',borderBottomWidth:1, height: 50, flex: 1, backgroundColor: '#E8E8E8'}}/>
            {this.showHeader()}
            <Text style={{marginLeft: 15, marginRight: 15, flex: 1, textAlign: 'left'}}>{this.props.details.content}</Text>
            {this.showFooter()}
        </View>
    )
  }
